/* BHUBONDANGA MASTER LOCK V7.1.1 — NATIVE INDEX DELEGATION + STABLE SOCIAL + ANALYTICS */
(() => {
  'use strict';
  if (window.BhubondangaMaster?.version === '7.1.1') return;
  ...
  function enhanceCard(card){
    ...
    /* V7.1.1: Index owns its canonical social DOM in feed.html. Never replace it here. */
  ...
  async function boot(){
    ...
    /* V7.1.1 ownership lock: feed.html is the ONLY Index owner for reaction/comment/reels/composer. */
  ...
  W.BhubondangaMaster=Object.freeze({version:'7.1.1',client,auth,toast,setMessagePermission,refreshPostSocial,react,openStoryDoor,openMagicDoor});
...
(() => {
  ...
  /* V7.1.1: VISUAL-ONLY reaction layer.
